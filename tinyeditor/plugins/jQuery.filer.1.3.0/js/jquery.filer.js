                ...
                f = {
                    ...
                    _upload: function (i) {
                        ...
                        var resizeImage = function (settings) {
                            ...
                            var maxSize = n.settingImage.maxSize;
                        ...
                        resizeImage({
                            file: c.file,
                            maxSize: n.settingImage.maxSize
                        }).then(function (resizedImage) {
                            formData.append(s.attr('name'), resizedImage, (c.file.name ? c.file.name : false));
                            if (n.uploadFile.data != null && $.isPlainObject(typeof (n.uploadFile.data) == "function" ? n.uploadFile.data(resizedImage) : n.uploadFile.data)) {
