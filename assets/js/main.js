(function ($) {
    ...
    $('[data-countdown]').each(function() {
        ...
        // Nếu là today+2 thì lấy ngày hiện tại cộng 2 ngày
        if (typeof finalDate === 'string' && finalDate.toLowerCase().indexOf('today+2') !== -1) {
            var now = new Date();
            ...
            $this.countdown(finalDate, function(event) {
                $this.html(event.strftime(
                    '<div class="countdown_area">' +
                        '<div class="single_countdown"><div class="countdown_number">%D</div><div class="countdown_title">day</div></div>' +
                        '<div class="single_countdown"><div class="countdown_number">%H</div><div class="countdown_title">hour</div></div>' +
                        '<div class="single_countdown"><div class="countdown_number">%M</div><div class="countdown_title">min</div></div>' +
                        '<div class="single_countdown"><div class="countdown_number">%S</div><div class="countdown_title">sec</div></div>' +
                    '</div>'
                ));
            });
        } else {
            console.error('Không tìm thấy hàm countdown! Kiểm tra lại file jquery.countdown.js');
        }
    });	
