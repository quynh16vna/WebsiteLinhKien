...
public partial class Admin_ProductList : System.Web.UI.Page
{
    ...
    public void LoadData()
    {
        ...
        //
        var query = db.Products.OrderByDescending(x => x.CreateTime).Select(x => new
        {
            ID = x.ProductID,
            x.Title,
            x.Avatar,
            ...
            x.CreateBy,
            x.CreateTime,
            catID = x.ProductCategoryID,

            CatTitle = x.ProductCategory.Title,
            MainCatTitle = x.ProductCategory.ProductMainCategory.Title,
            //AccountUsername = x.ProductCategory.ProductMainCategory.Account.Username
        ...
        string url = "~/Admin/ProductList.aspx?catid={0}&title={1}&page={2}";
    ...
    public void LoadCategoryData()
    {
        ...
        var query = db.ProductCategories.Select(x => new { x.ProductCategoryID, x.Title });
    ...
    protected void LinkButton_SaveAvatar_Click(object sender, EventArgs e)
    {
        ...
        //tìm một sản phẩm có ID như trên
        DBEntities db = new DBEntities();
